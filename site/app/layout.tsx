...
export const metadata: Metadata = {
  title: "Mosaic Database — branchable Postgres for agents",
  ...
  openGraph: { title: "Mosaic Database", description: "Branchable PostgreSQL for agents with governed SQL and explicit operational boundaries.", url: "https://database.mosaicos.com", siteName: "Mosaic", type: "website" },
